...
exports.generateStack = async (body) => {
    ...
    const environment = {
        ...
        "CLOUD_PORTAINER_URL": conf.f_cloud_portainer_api_url,
        "CLOUD_PORTAINER_LOGIN": conf.f_cloud_portainer_login,
        "CLOUD_PORTAINER_PWD": __cryptr.decrypt(conf.f_cloud_portainer_password),
